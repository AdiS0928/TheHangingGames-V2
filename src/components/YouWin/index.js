...
const YouWin = () => { 
  ...
  return (
    <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', height: '100vh', width: '100vw'}}>
      ...
      <h1 style={{fontSize: '6vw', fontWeight: '300', marginTop: '50px'}}>YOU WIN!</h1>
      ...
      <h1 style={{fontSize: '2.5vw', marginTop: '-15px', fontWeight: '300', marginBottom: '100px'}}>Oh wait, wrong era!</h1>
        ...
        <div style={{display: 'flex', width: '100vw', justifyContent: 'center', alignItems: 'center', gap: '40px'}}>
            <Link to="/" style={{textDecoration: 'none'}}>
                <button  style={{backgroundColor: 'transparent', border: 'none', height: '90px', width: '370px', backgroundSize: 'cover', backgroundPosition: 'center', backgroundImage: `url('${ButtonBox}')`, display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '10px', cursor: 'grab', fontSize: '30px', color: 'white'}} >MAIN MENU</button>
            </Link>
